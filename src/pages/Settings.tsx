              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                  <div>
                    ...
                    <div className="text-sm text-neutral-600">Receive updates about your campaigns</div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                  <div>
                    <div className="font-medium text-neutral-900">Marketing Updates</div>
                    <div className="text-sm text-neutral-600">Get tips and product updates</div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h4 className="font-medium text-neutral-900">{apiKey.name}</h4>
                      ...
                      <div className="mt-3 flex items-center space-x-2">
                        <div className="font-mono text-sm bg-neutral-100 px-3 py-2 rounded-lg flex-1">
      ...
      case 'notifications':
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="font-medium text-neutral-900 mb-4">Campaign Notifications</h4>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                      <div>
                        <div className="font-medium text-neutral-900">{notification.name}</div>
                        <div className="text-sm text-neutral-600">{notification.description}</div>
                      </div>
              ...
              <div>
                <h4 className="font-medium text-neutral-900 mb-4">System Notifications</h4>
                <div className="space-y-3">
                  {[
      ...
      case 'security':
        return (
          <div className="space-y-6">
            ...
            <Card padding="lg">
              <h4 className="font-medium text-neutral-900 mb-4">Password</h4>
              <div className="space-y-4">
                <Input
            ...
            <Card padding="lg">
              <h4 className="font-medium text-neutral-900 mb-4">Active Sessions</h4>
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                  <div>
                    <div className="font-medium text-neutral-900">Current Session</div>
                    <div className="text-sm text-neutral-600">Chrome on macOS • San Francisco, CA</div>
                  </div>
                  <Badge variant="success" size="sm">Active</Badge>
                </div>
                <div className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                  <div>
                    <div className="font-medium text-neutral-900">Mobile App</div>
                    <div className="text-sm text-neutral-600">iPhone • Last active 2 hours ago</div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <Card padding="lg">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h4 className="font-medium text-neutral-900 mb-2">Current Plan</h4>
                  <div className="flex items-center space-x-3">
                    <Badge variant="primary" size="lg">Pro Plan</Badge>
                    <span className="text-neutral-600">$299/month</span>
                  </div>
                </div>
                <Button variant="outline">
                  Change Plan
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  <span className="text-neutral-600">Billing email:</span>
                  <div className="font-medium">billing@techflow.com</div>
                </div>
              </div>
            </Card>
            
            <Card padding="lg">
              <h4 className="font-medium text-neutral-900 mb-4">Usage This Month</h4>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-neutral-600">API Calls</span>
                  <span className="font-medium">24,567 / 100,000</span>
                </div>
                <div className="w-full bg-neutral-200 rounded-full h-2">
                  <div className="bg-primary-600 h-2 rounded-full" style={{ width: '24.5%' }}></div>
                </div>
                
                <div className="flex items-center justify-between">
                  <span className="text-neutral-600">Active Campaigns</span>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-neutral-50 border-b border-neutral-200">
                    <tr>
                      <th className="text-left py-3 px-6 font-medium text-neutral-700">Member</th>
                      <th className="text-left py-3 px-6 font-medium text-neutral-700">Role</th>
                      <th className="text-left py-3 px-6 font-medium text-neutral-700">Last Active</th>
                      <th className="text-left py-3 px-6 font-medium text-neutral-700">Status</th>
                      <th className="text-left py-3 px-6 font-medium text-neutral-700">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-neutral-100">
                      <td className="py-4 px-6">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-neutral-600">sarah@techflow.com</div>
                          </div>
                        </div>
                      </td>
                      <td className="py-4 px-6">
                      ...
                      <td className="py-4 px-6 text-neutral-600">Active now</td>
                      <td className="py-4 px-6">
                    ...
                    <tr className="border-b border-neutral-100">
                      <td className="py-4 px-6">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-neutral-600">marcus@techflow.com</div>
                          </div>
                        </div>
                      </td>
                      <td className="py-4 px-6">
                      ...
                      <td className="py-4 px-6 text-neutral-600">2 hours ago</td>
                      <td className="py-4 px-6">
                        <Badge variant="success" size="sm" dot>Active</Badge>
                      </td>
                      <td className="py-4 px-6">
