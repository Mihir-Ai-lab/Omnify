        ...
        <main className="flex-1 p-6 animate-fade-in">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
            ...
            <div className="flex items-center space-x-4 mt-4 lg:mt-0 animate-slide-in-right">
              ...
              <Button variant="futuristic" size="sm" leftIcon={<CreditCard className="w-4 h-4" />}>
            ...
            <Card variant="futuristic" padding="lg" className="animate-slide-in-up">
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-3">
                  ...
                  <Button variant="ghost" size="sm" fullWidth className="text-red-400 hover:text-red-300">
                    Cancel Subscription
                  </Button>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card variant="futuristic" padding="lg" className="animate-slide-in-up" style={{ animationDelay: '0.1s' }}>
              ...
              <div className="space-y-3">
                {invoices.slice(0, 4).map((invoice, index) => (
                  ...
                  >
                    ...
                    <Button variant="ghost" size="sm" className="text-slate-400 hover:text-white ml-4">
              ...
              <div className="mt-6">
                <Button variant="outline" size="sm" fullWidth leftIcon={<ExternalLink className="w-4 h-4" />}>
                  View Billing Portal
                </Button>
              </div>
            </Card>
